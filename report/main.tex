...
\writeme{Optional — supervisor, second marker, anyone who helped.}
...
% ============================== BIBLIOGRAPHY =================================
\nocite{*}  % TEMP: forces all references.bib entries to render so the bib can be
            % verified before any \cite exists. REMOVE once you cite real sources.
...
% Full 18-tool JSON schema, example requests/responses. Good place to move
